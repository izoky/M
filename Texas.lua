...
{
{text = ' ‹ تفعيل االوضع المجاني › ',type = 'text'},{text = ' ‹ تعطيل االوضع المجاني › ',type = 'text'},
},
{
...
if text == " ‹ تفعيل االوضع المجاني › " then 
Redis:del(Texas .."free:bot")
send(msg.chat_id,msg.id,' ‹ تم تفعيل االوضع المجاني › ',"md",true)  
end
if text == " ‹ تعطيل االوضع المجاني › " then 
Redis:set(Texas .."free:bot",true)
send(msg.chat_id,msg.id,' ‹ تم تعطيل االوضع المجاني › ',"md",true)  
end
-----تشغيل البوتات ---
...
send(msg.chat_id,msg.id,"‹ رسل المعرف مع علامه @ ›")
end
end
